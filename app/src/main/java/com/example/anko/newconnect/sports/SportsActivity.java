package com.example.anko.newconnect.sports;
...
public class SportsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
     ...
     /*  Toolbar toolbar = (Toolbar) findViewById(R.id.sports_toolbar);
        ...
        mDatabase = FirebaseDatabase.getInstance().getReference().child("Sports_Messages");
        ...
        mAuthListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                if (firebaseAuth.getCurrentUser()==null){
                    Intent loginIntent = new Intent(SportsActivity.this,RegisterActivity.class);
