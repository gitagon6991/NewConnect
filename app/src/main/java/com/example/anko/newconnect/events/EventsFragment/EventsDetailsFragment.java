package com.example.anko.newconnect.events.EventsFragment;
...
public class EventsDetailsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        invite.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                addNotifications();
                Toast.makeText(getContext(),"Invite to Event Sent",Toast.LENGTH_SHORT).show();
    ...
    private void readPost() {
        ...
        DatabaseReference reference2 = FirebaseDatabase.getInstance().getReference("EventsPosts").child(postid);
    ...
    private void addNotifications(){
        ...
        hashMap.put("text", "invited you to an event");
        hashMap.put("postid", "");
