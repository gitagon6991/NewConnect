package com.example.anko.newconnect.travel.TravelFragment;
...
public class TravelDetailsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        invite.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                addNotifications();
                Toast.makeText(getContext(),"Travelling Invite Sent",Toast.LENGTH_SHORT).show();
    ...
    private void readPost() {
        ...
        DatabaseReference reference3 = FirebaseDatabase.getInstance().getReference("TravelPosts").child(postid);
    ...
    private void addNotifications(){
        ...
        hashMap.put("text", "invited you on a travel adventure");
        hashMap.put("postid", "");
